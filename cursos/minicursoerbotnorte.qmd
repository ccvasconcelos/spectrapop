...
análises multivariadas aplicadas à discriminação de espécies.

<figure style="text-align:center;">

![](images/flyer_erbot.png){.slide style="display:block;"}
...
> Interessados devem entrar em contato com [Jesiane (91
> 988199025)](https://wa.me/91988199025), realizar o pagamento via PIX
> para este número e enviar o comprovante.

## Linha do tempo

### Manhã (aula ministrada por Flávia Durgante)

-   Fundamentos da espectroscopia no infravermelho próximo (NIR)
-   Aplicações em herbários e identificação de espécies
-   Introdução a análises multivariadas
...
-   Demonstração da aquisição de espectros em exsicatas (amostras de
    referência)\
-   Estrutura dos dados espectrais gerados pelo equipamento
...
4.  Grazielle Sales Teodoro

5.  Loarena Leal Cruz

6.  Lucas de Jesus Camilo

7.  Mellissa Sousa Sobrinho
