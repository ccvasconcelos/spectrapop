...
![](images/2_1.png){.slide style="display:block;"}

<figcaption style="font-size:0.9rem; color:#555; margin-top:6px;">

Flyer de divulgação do 2º Curso de Espectroscopia em Herbário com Micronir: Teoria e Prática do Projeto SpectraPop.
...
![](/images/programacao.png)

# Equipe de organização e treinamento

<img src="images/user.png" width="12"/> Profa. Dra. Flávia Durgante (Coordenadora do Projeto SpectraPop), KIT/INPA/MAUA/ATTO <a href="http://lattes.cnpq.br/9866263113578229" target="_blank"><img src="images/lattes.png" width="18"/></a>

<img src="images/user.png" width="12"/> Dra. Caroline Vasconcelos (Bolsista do Projeto SpectraPop), INPA <a href="http://lattes.cnpq.br/1535461703335857" target="_blank"><img src="images/lattes.png" width="18"/></a>

<img src="images/user.png" width="12"/> Prof. Dr. Michael Hopkins (Colaborador), Curadoria do Herbário INPA <a href="http://lattes.cnpq.br/5738793047673962" target="_blank"><img src="images/lattes.png" width="18"/></a>

<img src="images/user.png" width="12"/> Dra. Samyra Ramos (Colaboradora), INPA <a href="http://lattes.cnpq.br/1333559162162849" target="_blank"><img src="images/lattes.png" width="18"/></a>

<img src="images/user.png" width="12"/> Me. Kaio Cunha (Colaborador), INPA <a href="http://lattes.cnpq.br/2664299098538335" target="_blank"><img src="images/lattes.png" width="18"/></a>

<img src="images/user.png" width="12"/> Me. Luiz Melo (Colaborador), INPA <a href="http://lattes.cnpq.br/0848738423393318" target="_blank"><img src="images/lattes.png" width="18"/></a>
...
19. Eliandra Rodrigues (Ouvinte)

20. Yasmin Guimarães (Ouvinte)

[Observação: Ouvintes (virtuais e presenciais) não terão direito a certificado.]{style="color:tomato;"}
...
![](images/2_2.jpeg){.slide style="display:block;"}
