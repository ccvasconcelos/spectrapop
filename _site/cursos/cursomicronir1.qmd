...
Além disso, o minicurso busca identificar desafios práticos no uso do equipamento, contribuindo para o desenvolvimento de um protocolo de aplicação no âmbito do [Projeto SpectraPop](https://spectrapop.netlify.app/inicio).
